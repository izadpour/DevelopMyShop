...
namespace Shop.Management.Infrastructure.EFCore.Repository
{
    public class ProductPictureRepository:RepositoryBase<long,ProductPicture>,IProductPictureRepository
    {
        ...
        {
            var editProductPicture = _context.ProductPictures
                ...
                }).AsTracking().FirstOrDefault(x=>x.Id.Equals(id));
        ...
        public List<ProductPictureViewModel> Search(ProductPictureSearchModel searchModel)
        {
            ...
            if (!searchModel.ProductId.Equals(0))
            {
                query = query.Where(x => x.Id.Equals(searchModel.ProductId));
            }
